<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YagOrani.aspx.cs" Inherits="WebApplication2.YagOrani" %>
    ...
    <form id="form2" runat="server" style="text-align:center;">
        ...
        <div style="display: flex; margin-top:150px;flex-wrap: nowrap;">
            <div style="flex: 0 0 30%;">
                ...
                <asp:Button ID="YagOrani_Button" runat="server" Width="80%" Text="Vücut Yağ Oranı" CssClass="buttongirisyesil" OnClick="YagOrani_Button_Click"/>
            ...
            <div style="background-color:#E1E1E1;border-radius:10px;flex: 0 0 25%;">
                <asp:Label ID="Label3" runat="server" Text="Yağ Oranı Nedir?" Width="60%" Height="50px" CssClass="baslik"></asp:Label>
                <br />
                <br />
                <asp:Label ID="Label4" runat="server" CssClass="icerik" Text="Vücut yağ oranı, bir kimsenin vücudunda yer alan yağ doku ağırlığının toplam vücut ağırlığına oranıdır. Sağlıklı birinin vücudunda bulunan yağ oranı cinsiyetler arasında farklılık gösterebilmektedir. Yağ dokusunun vücut ağırlığına olan oranı uygun görülen sınırın üstüne çıkarsa kişide çeşitli sağlık problemleri baş gösterebilir." Height="50px"></asp:Label>
                <br />
                <br />
                <br />
                <br /><br />
            ...
            <div style="background-color:#000000;margin: auto;border-radius:10px;flex: 0 0 35%;">
                <div style="background-color:#000000;border-radius:10px">
                    ...
                    </asp:DropDownList>                    <asp:TextBox ID="boylab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Boyunuz"></asp:TextBox>
                    <asp:TextBox ID="bellab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Bel Çevreniz"></asp:TextBox>
                    <asp:TextBox ID="kalcalab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Kalça Çevreniz"></asp:TextBox>
                    <asp:TextBox ID="boyunlab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Boyun Çevreniz"></asp:TextBox>
