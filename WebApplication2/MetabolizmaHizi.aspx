<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetabolizmaHizi.aspx.cs" Inherits="WebApplication2.MetabolizmaHizi" %>
    ...
    <form id="form2" runat="server" style="text-align:center;">
        ...
        <div style="display: flex; margin-top:150px;flex-wrap: nowrap;">
            <div style="flex: 0 0 30%;">
                ...
                <asp:Button ID="MetabolizmaHizi_Button" runat="server" Width="80%" Text="Bazal Metabolizma Hızı" CssClass="buttongirisyesil" OnClick="MetabolizmaHizi_Button_Click"/>
            ...
            <div style="background-color:#E1E1E1;border-radius:10px;flex: 0 0 25%;">
                <asp:Label ID="Label3" runat="server" Text="Bazal Metabolizma Nedir?" Width="60%" Height="50px" CssClass="baslik"></asp:Label>
                <br />
                <br />
                <asp:Label ID="Label4" runat="server" CssClass="icerik" Text="Bazal metabolizma, vücudun yalnızca yaşamsal fonksiyonları (vücudu sıcak tutma, nefes alma vb.) idame ettirmek için enerji kullanan metabolik sisteme verilen addır. Bazal metabolizma hızı kişilerin aktivite seviyelerine, yaşına ve cinsiyetine göre farklılık gösterir." Height="50px"></asp:Label>
                <br />
                <br />
                <br />
                <br /><br />
