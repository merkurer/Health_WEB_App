<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YemekEkle.aspx.cs" Inherits="WebApplication2.YemekEkle" %>
    ...
    <form id="form2" runat="server" style="text-align:center;">
        ...
        <div style="display: flex; margin-top:100px;flex-wrap: nowrap;">
            <div style="flex: 0 0 30%;">
                <asp:Button ID="YemekAra_Button" runat="server" Width="80%" Text="Yemek Ara" CssClass="buttongiris" OnClick="YemekAra_Button_Click"/>
                <asp:Button ID="YemekEkle_Button" runat="server" Width="80%" Text="Yemek Ekle" CssClass="buttongirisyesil" OnClick="YemekEkle_Button_Click"/>
            </div>
            <div style="background-color:#000000;margin: auto;border-radius:10px;flex: 0 0 35%;">
                <div style="background-color:#000000;border-radius:10px">
                    ...
                    <asp:TextBox ID="kalorilab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Kalori"></asp:TextBox>
                    <asp:TextBox ID="karbonhidratlab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Karbonhidrat"></asp:TextBox>
                    <asp:TextBox ID="proteinlab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Protein"></asp:TextBox>
                    <asp:TextBox ID="yaglab" runat="server" Width="60%" Height="50px" CssClass="textbox" placeholder="Yağ"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <br />
                    <br />
                    <asp:Button ID="Kaydet_Button" runat="server" Width="60%" Text="Kaydet" CssClass="beyazbutton" OnClick="Kaydet_Button_Click"/>
                    <br />
                    <br />
                    <br />
                    <br />
