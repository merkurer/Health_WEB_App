<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KalcaOrani.aspx.cs" Inherits="WebApplication2.KalcaOrani" %>
    ...
    <form id="form2" runat="server" style="text-align:center;">
        ...
        <div style="display: flex; margin-top:150px;flex-wrap: nowrap;">
            <div style="flex: 0 0 30%;">
                ...
                <asp:Button ID="KalcaOrani_Button" runat="server" Width="80%" Text="Bel Kalça Oranı" CssClass="buttongirisyesil" OnClick="KalcaOrani_Button_Click"/>
            ...
            <div style="background-color:#E1E1E1;border-radius:10px;flex: 0 0 25%;">
                <asp:Label ID="Label3" runat="server" Text="Bel-Kalça Oranı Nedir?" Width="60%" Height="50px" CssClass="baslik"></asp:Label>
                <br />
                <br />
                <asp:Label ID="Label4" runat="server" CssClass="icerik" Text="Bel çevresi ile kalça çevresinin oranıdır. Bilimsel çalışmalar sonucunda bu değer ölçülerek, bireylerin gelecekte karşılaşabilecekleri potansiyel sağlık problemlerinin risk düzeyi kolayca tespit edilebilmektedir. Bilim insanlarının çalışmalarına göre aşırı kiloların vücudun hangi bölgesinde toplandığını gösterdiği için bireyin sağlık problemi yaşama riski hakkında oldukça doğru sonuçlar vermektedir. Uzmanlar en az üç ayda bir hesaplanarak, düzenli bir şekilde takip edilmesini öneriyor." Height="50px"></asp:Label>
                <br />
                <br />
                <br />
                <br /><br />
